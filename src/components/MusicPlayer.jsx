...
function MusicPlayer() {
  return (
    <div className="musicPlayer flex flex-col px-5 w-[620px] border-2 border-black py-3 bg-[#232a4e] rounded-xl mt-5">
        { /* Upper Part */}
        <div className="upperPart flex items-center justify-between">
            ...
            <div className="detailsf flex flex-col ml-4">
                <span className="text-[1rem]">A Potion for Love</span>
                <span className="text-sm text-gray-500">AURORA</span>
            </div>
            </div>
            <div>
                <img
